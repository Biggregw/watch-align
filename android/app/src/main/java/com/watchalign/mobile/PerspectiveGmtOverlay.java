    ...
    private static Bitmap renderNative(Bitmap source,Mat H,String modelRef,int overlayColor){
        ...
        if(Gmt126710BlnrMaster.supports(modelRef)){
            ...
            for(int h:new int[]{6,9}){
                double a=Gmt126710BlnrMaster.angleForHour(h);
                drawRectTarget(c,H,Gmt126710BlnrMaster.BATON_CENTER_R,Gmt126710BlnrMaster.BATON_TANGENTIAL_HALF,Gmt126710BlnrMaster.BATON_RADIAL_HALF,a,outer);
                drawRectTarget(c,H,Gmt126710BlnrMaster.BATON_CENTER_R,Gmt126710BlnrMaster.BATON_LUME_TANGENTIAL_HALF,Gmt126710BlnrMaster.BATON_LUME_RADIAL_HALF,a,inner);
            }
