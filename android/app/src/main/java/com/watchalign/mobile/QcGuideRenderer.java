...
final class QcGuideRenderer {
    static Bitmap render(Bitmap watch) {
        ...
        try {
            ...
            Mat out=src.clone();
            Scalar cyan=new Scalar(242,213,50);      // BGR
            ...
            for(int h=1;h<=12;h++) {
                ...
                Imgproc.line(out,new Point(p0.x,p0.y),new Point(p1.x,p1.y),new Scalar(120,120,120),1,Imgproc.LINE_AA,0);
                ...
                if(marker!=null) {
                    ...
                    int level=QcGuideMath.severity(angular,radial); sev=level==0?green:level==1?amber:red;
                    ...
                    Imgproc.line(out,new Point(ideal.x,ideal.y),new Point(actual.x,actual.y),sev,2,Imgproc.LINE_AA,0);
                }
            ...
            Imgproc.putText(out,"cyan=dial  yellow=marker ring  x=ideal  o=measured",new Point(18,30),
                    Imgproc.FONT_HERSHEY_SIMPLEX,0.48,white,1,Imgproc.LINE_AA,false);
